...
Explanation occurs _after_ something else and depends on it, yet brings something new - shines new light on the subject.
...
Understanding doesn't come _from_ explanation, but explanation helps form the web that holds everything together.
...
### 3. Talk _About_ the Subject

Explanation guides are _around_ the topic. You should be able to place "About" before the title:
...
Harold McGee's _On Food and Cooking_:
...
It explains _why_ we do what we do in the kitchen.
