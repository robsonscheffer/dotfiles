...
> _"The agent was given a ticket with a clear acceptance criterion: 'Tests verify flag gating logic.'"_
...
> _"Four tidy examples. Tests passed. Rubocop clean. Pre-commit hooks green."_
...
> _"But nobody stopped to ask: does anyone else do this?"_
...
> **_"Literal compliance without codebase awareness produces code that works but doesn't belong."_**
